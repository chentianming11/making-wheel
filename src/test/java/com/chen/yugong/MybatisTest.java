...
import com.chen.yugong.framework.mybatis.session.SqlSessionFactoryBuilder;
...
public class MybatisTest {
    ...
    public void test2() {
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build("mybatis/config/mybatis.properties");
        SqlSession session = sqlSessionFactory.openSession();
        Blog blog = session.selectOne("com.chen.yugong.demo.mapper.BlogMapper.selectBlogById", 1);
        System.out.println(blog);

        System.out.println("=============");
        SqlSession session2 = sqlSessionFactory.openSession();
        Blog blog2 = session2.selectOne("com.chen.yugong.demo.mapper.BlogMapper.selectBlogById", 1);
        System.out.println(blog2);
    }
}
